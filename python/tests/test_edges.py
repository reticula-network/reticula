...
def test_temporal_network_creation():
    ...
    assert_array_equal(net.vertices(), [0, 1, 2])

    net = ret.undirected_temporal_network(
        edges, verts=[5])
    # assert len(net.edges()) == 2
    assert_array_equal(net.vertices(), [0, 1, 2, 5])
...
def test_temporal_hypernetwork_creation():
    ...
    # assert len(net.edges()) == 2
    assert_array_equal(net.vertices(), [0, 1, 2, 3])
    ...
    # assert len(net.edges()) == 2
    assert_array_equal(net.vertices(), [0, 1, 2, 3, 5])
