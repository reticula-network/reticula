...
void define_deterministic(nanobind::module_& m) {
  ...
  m.def(
    "cycle_graph", &reticula::cycle_graph, nanobind::arg("size"),
    nanobind::call_guard<nanobind::gil_scoped_release>());

  m.def(
    "star_graph", &reticula::star_graph, nanobind::arg("size"),
    nanobind::call_guard<nanobind::gil_scoped_release>());

  m.def(
    "wheel_graph", &reticula::wheel_graph, nanobind::arg("size"),
    nanobind::call_guard<nanobind::gil_scoped_release>());

  m.def(
    "complete_graph", &reticula::complete_graph, nanobind::arg("size"),
    nanobind::call_guard<nanobind::gil_scoped_release>());
