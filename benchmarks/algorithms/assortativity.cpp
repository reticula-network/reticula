...
static void BM_Algorithms_Assortativity_DegreeAssortativity_Undirected(
...
static void BM_Algorithms_Assortativity_DegreeAssortativity_Directed_InIn(
  benchmark::State& state) {
  ...
  for (auto _ : state) {
    auto result = reticula::degree_assortativity(
      net, reticula::direction::in, reticula::direction::in);
    benchmark::DoNotOptimize(result);
  }
...
static void BM_Algorithms_Assortativity_DegreeAssortativity_Directed_OutOut(
  benchmark::State& state) {
  auto net = create_random_directed_network(
    static_cast<std::size_t>(state.range(0)),
    static_cast<std::size_t>(state.range(1)));
  ...
  for (auto _ : state) {
    auto result = reticula::degree_assortativity(
      net, reticula::direction::out, reticula::direction::out);
    benchmark::DoNotOptimize(result);
  }
...
static void BM_Algorithms_Assortativity_DegreeAssortativity_Directed_InOut(
  benchmark::State& state) {
  auto net = create_random_directed_network(
    static_cast<std::size_t>(state.range(0)),
    static_cast<std::size_t>(state.range(1)));
  ...
  for (auto _ : state) {
    auto result = reticula::degree_assortativity(
      net, reticula::direction::in, reticula::direction::out);
    benchmark::DoNotOptimize(result);
  }
...
static void BM_Algorithms_Assortativity_AttributeAssortativity_Undirected(
  benchmark::State& state) {
  auto net = create_random_undirected_network(
    static_cast<std::size_t>(state.range(0)),
    static_cast<std::size_t>(state.range(1)));
...
static void BM_Algorithms_Assortativity_AttributeAssortativity_Directed(
  benchmark::State& state) {
  auto net = create_random_directed_network(
    static_cast<std::size_t>(state.range(0)),
    static_cast<std::size_t>(state.range(1)));
  ...
  for (auto _ : state) {
    auto result = reticula::attribute_assortativity(
      net, mutator_attr_fun, mutated_attr_fun);
    benchmark::DoNotOptimize(result);
  }
